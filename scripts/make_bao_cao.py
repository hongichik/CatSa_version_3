...
def _load_demo2_rows() -> list[dict]:
    ...
    mapping = [
        ...
        ("retailrocket_item_hon_5", "CatSA", LOG_RETAIL, "CatSA/baseline/CatSA_v1.log", "v1", "demo2"),
        ("retailrocket_item_hon_5", "CatSA", LOG_RETAIL, "CatSA/baseline/CatSA_v2.log", "v2", "demo2"),
        ("retailrocket_item_hon_5", "CatSA", LOG_RETAIL, "CatSA/baseline/CatSA_v3.log", "v3", "demo2"),
        ("retailrocket_item_hon_5", "CatSA", LOG_RETAIL, "CatSA/baseline/CatSA_v4.log", "v4", "demo2"),
        ("retailrocket_item_hon_5", "CatSA", LOG_RETAIL, "CatSA/baseline/CatSA_v2_mg_core.log", "v2_mg_core", "demo2"),
        ("retailrocket_2_5", "CatSA", LOG_RETAIL, "CatSA/ablation_len/CatSA_2_5.log", "v1", "demo2"),
        ("retailrocket_2_7", "CatSA", LOG_RETAIL, "CatSA/ablation_len/CatSA_2_7.log", "v1", "demo2"),
        ("retailrocket_3_6", "CatSA", LOG_RETAIL, "CatSA/ablation_len/CatSA_3_6.log", "v1", "demo2"),
        ("retailrocket_4_7", "CatSA", LOG_RETAIL, "CatSA/ablation_len/CatSA_4_7.log", "v1", "demo2"),
        ("retailrocket_category", "CatSA", LOG_RETAIL, "CatSA/ablation_len/CatSA_category.log", "v1", "demo2"),
        ("retailrocket_item_hon_5", "CORE", LOG_RETAIL, "CORE/main/core_trm_retailrocket.log", "core_trm", "demo2"),
        ("retailrocket_1_4", "CORE", LOG_RETAIL, "CORE/main/core_trm_retailrocket_1_4.log", "core_trm", "demo2"),
        ("retailrocket_3_7", "CORE", LOG_RETAIL, "CORE/main/core_trm_retailrocket_3_7.log", "core_trm", "demo2"),
        ("retailrocket_same_leaf", "CORE", LOG_RETAIL, "CORE/main/core_trm_retailrocket_same_leaf.log", "core_trm", "demo2"),
        ("retailrocket_cold", "CORE", LOG_RETAIL, "CORE/main/core_trm_retailrocket_cold.log", "core_trm", "demo2"),
        ("retailrocket_item_hon_5", "MSGIFSR", LOG_RETAIL, "MSGIFSR/main/MSGIFSR_retailrocket.log", "msgifsr", "demo2"),
        ("retailrocket_4_7", "LINK", LOG_RETAIL, "LINK/main/LINK_retailrocket.log", "link", "demo2"),
    ]
