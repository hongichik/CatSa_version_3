...
from CatSA.ensemble_eval import (  # noqa: E402
    REF_RUN, TOP_K, _core_logits, _load_catsa_model, _load_core_model,
)

MODELS = {
    "catsa_v3_full": "checkpoints/CatSA/retailrocket/catsa_plus_v3_full",
    "core_trm": "checkpoints/CORE/retailrocket/core_trm",
}
...
def main() -> None:
    ...
    with open("checkpoints/repeat_aware_result.yaml", "w", encoding="utf-8") as f:
        yaml.safe_dump(result, f, allow_unicode=True, sort_keys=False)
    print("\n[repeat_aware] Đã ghi checkpoints/repeat_aware_result.yaml")
